    ...
    <div className="w-full overflow-hidden rounded-xl border border-ink-700 bg-ink-900 text-left shadow-2xl shadow-black/40">
      <div className="flex items-center justify-between gap-3 border-b border-ink-700 px-4 py-2.5">
        <div className="flex min-w-0 items-center gap-1.5">
          ...
          <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-ink-700" />
          <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-ink-700" />
          <span className="ml-3 hidden truncate text-xs text-ink-400 sm:inline">interview-prep — twoSum.js</span>
        </div>
      ...
      <pre className="min-h-[240px] overflow-x-auto p-4 font-[family-name:var(--font-mono)] text-xs leading-6 text-ink-300 sm:min-h-[280px] sm:p-5 sm:text-sm">
        {visibleText}
        {!reducedMotion && (
          <span
